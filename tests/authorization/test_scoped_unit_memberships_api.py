...
@pytest.mark.asyncio
async def test_api_unit_memberships_rejects_primary_and_inactive_together(
    db_session: AsyncSession,
    api_client: AsyncClient,
    clean_test_redis,
):
...
@pytest.mark.asyncio
async def test_api_unit_memberships_primary_true_keeps_assignment_active(
    db_session: AsyncSession,
    api_client: AsyncClient,
    clean_test_redis,
):
